...
const Contact = () => {
  ...
  return (
    <div className="bg-[#EBEBEB]">
      {contextHolder}
      <div className="xl:mx-[9%] lg:mx-[7%] mx-[5%] flex lg:flex-row flex-col justify-between xl:py-24 md:py-20 py-12 ">
        <div
        ...
        >
          <h2 className="2xl:text-[48px] xl:text-[40px] md:text-[36px] text-[30px] font-semibold 2xl:leading-[52px] xl:leading-[48px] md:leading-[38px] leading-[32px] text-[#011E3C] inter-font tracking-[-2px] md:mb-8 mb-5">
            Join Duomo for Premier Corporate Stays
          </h2>
          <p className="xl:text-[18px] sm:text-[16px] text-[15px] font-normal xl:leading-[28px] leading-[23px] text-[#001D3D] opacity-75 inter-font ">
            Join our prestigious network of corporate partners and elevate your
            experience with Duomo&apos;s premium accommodations. Our exclusive
            portfolio of holiday homes, strategically located in prime
            destinations, is meticulously curated to meet the highest standards.
            We prioritize exceptional service, personalized attention, and a
            commitment to making every stay memorable. Partner with Duomo and be
            part of a legacy of unparalleled hospitality in the world of holiday
            homes
          </p>
        </div>
        <div
